...
*/
export function generate_ball(canvas, event) {
    wasm.generate_ball(addHeapObject(canvas), addHeapObject(event));
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_scrollX_71fd132321ec74e6 = function() { return handleError(function (arg0) {
        const ret = getObject(arg0).scrollX;
        return ret;
    }, arguments) };
    imports.wbg.__wbg_scrollY_932e53491a590cb5 = function() { return handleError(function (arg0) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_0519_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
